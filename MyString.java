public class MyString {
    ...
    public static boolean subsetOf(String smallStr, String largeStr) {
        ...
        for (int i = 0; i < smallStr.length(); i++) {
            ...
            if (!largeStr.contains(String.valueOf(currentChar))) {
                return false;
            }
            largeStr = largeStr.replaceFirst(String.valueOf(currentChar), "");
        }
        return true;
    }
    ...
    public static String remove(String inputStr1, String inputStr2) {
        for (int i = 0; i < inputStr2.length(); i++) {
            ...
            if (inputStr1.contains(String.valueOf(currentChar))) {
                inputStr1 = inputStr1.replaceFirst(String.valueOf(currentChar), "");
            }
        }
        return inputStr1;
    }
